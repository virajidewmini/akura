...
export default function BasicTable() {
  ...
  return (
    ...
    >
        ...
        <Stack spacing={2}>
          <Typography variant="h3" gutterBottom> Checkin </Typography>
        ...
        <TableBody>
          {checkin && checkin.map((checkin) => (
            ...
            >
              ...
              <TableCell align="right"><Button variant="contained" onClick={() => navigate(`/checkin/${checkin._id}`)}>Update</Button></TableCell>
              <TableCell align="right"><Button variant="contained" onClick={() => handleDelete(checkin._id)}>Delete</Button></TableCell> 
          </TableRow>
          ))}
        </TableBody> 
      </Table>
